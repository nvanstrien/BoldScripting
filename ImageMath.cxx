...
int ImageMath(int argc, char *argv[])
{
  ...
  try
    ...
    {
      std::cout << " Error reading " << fn2 << " as a file  -- will treat " <<  argv[argct] << "  as a float value " << std::endl;
      isfloat=true;
    }
...
int main(int argc, char *argv[])
{
  ...
  if ( argc < 5 )
  {
    ...
    std::cout << "  addtozero		:" << std::endl;
    std::cout << "  overadd		:" << std::endl;
    ...
    std::cout << "\n  InvId			: Prints to cout  & writes to image " << std::endl;
    ...
    std::cout << "\n  Lipschitz		: Prints to cout  & writes to image" << std::endl;
